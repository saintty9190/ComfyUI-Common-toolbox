...
# ── VAE 预设 (通道数, 维度) ────────────────────────────────────────────
# latent_dim=2 → 输出 4D (B,C,H,W), latent_dim=3 → 输出 5D (B,C,1,H,W)
VAE_PRESETS = {
...
# ── 宽高比预设 (横向基准像素尺寸, 纵向时交换) ─────────────────────────
# 数值来自 ZImagePowerNodes, 基准 ~1.0MP (scale=1.0)
ASPECT_RATIOS = {
